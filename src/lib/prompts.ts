...
## blindHint 작성 규칙 (매우 중요!)
블라인드 모드에서 사용자가 장소를 모른 채 기대감을 느끼도록, 감각적이고 은유적인 힌트를 작성하세요.
- 절대 장소명, 주소, 직접적 설명을 쓰지 마세요
- 오감(시각, 청각, 후각, 미각, 촉각)을 활용하세요
- 문학적 비유, 의인화, 공감각적 표현을 사용하세요
- 짧고 리듬감 있게 (15자 내외)

좋은 예시:
- 카페: "한 모금에 시간이 천천히 녹는 곳" / "원두가 속삭이는 오후의 비밀"
- 횟집: "파도가 접시 위에 올라온 순간" / "바다의 보석이 혀 위에서 녹는 곳"
- 공원: "도시가 잠시 숨을 고르는 곳" / "발끝에서 시작되는 작은 여행"
- 바/펍: "밤이 깊을수록 대화가 맛있어지는 곳" / "얼음이 부딪히며 하루를 위로하는 곳"
- 미술관: "벽 위에 누군가의 꿈이 걸려 있는 곳"
- 고기집: "불꽃 위에서 춤추는 마블링의 향연"
- 빵집: "오븐에서 막 태어난 황금빛 아침"
- 전망대: "발아래 도시가 반짝이는 순간"

나쁜 예시 (너무 직접적):
- "바다景을 감상할 수 있는 곳" ← 설명문이라 재미없음
- "울릉도의 대표적인 관광지" ← 위치 노출, 설명적
- "신선한 해산물을 즐길 수 있는 곳" ← 직접적, 은유 없음

## 반드시 아래 JSON 형식으로만 응답하세요 (다른 텍스트 없이):
{
  "title": "코스 제목 (한글, 감성적으로)",
  "description": "코스 설명 (2-3문장, 한국어)",
  "blindTitle": "힌트형 제목 (예: '별빛 아래 걷는 길', '시간이 머무는 골목')",
  ...
  "stops": [
    {
      ...
      "estimatedTime": 60,
      "estimatedCost": 15000,
      "blindHint": "장소의 분위기/감각을 은유적으로 표현 (직접적 설명 금지! 예: 카페→'한 모금에 시간이 천천히 흐르기 시작하는 곳', 횟집→'바다가 접시 위에 올라온 순간', 공원→'도시가 잠시 숨을 고르는 곳', 바→'밤이 깊을수록 대화가 맛있어지는 곳')",
      "blindTitle": "감성적인 가려진 제목 (예: '시간의 교차점', '구름 위의 정원')"
    }
  ]
}`
}
