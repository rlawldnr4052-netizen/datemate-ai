...
export const preferenceTags: PreferenceTag[] = [
  ...
  { id: 't5', label: '#레트로', description: '과거로 떠나는 타임슬립', category: 'vibe', gradient: 'linear-gradient(135deg, #b45309, #f59e0b)', emoji: '' },
  { id: 't6', label: '#미니멀', description: '군더더기 없는 깔끔함', category: 'vibe', gradient: 'linear-gradient(135deg, #d1d5db, #9ca3af)', emoji: '' },

  // Place (장소)
  { id: 't7', label: '#LP바', description: '아날로그 감성 한 잔', category: 'place', gradient: 'linear-gradient(135deg, #7c3aed, #a78bfa)', emoji: '' },
  { id: 't8', label: '#루프탑', description: '하늘 가까운 핫플', category: 'place', gradient: 'linear-gradient(135deg, #0ea5e9, #67e8f9)', emoji: '' },
  { id: 't9', label: '#한옥', description: '전통과 현대의 만남', category: 'place', gradient: 'linear-gradient(135deg, #78350f, #b45309)', emoji: '' },
  ...
  { id: 't12', label: '#갤러리', description: '예술 작품 속 데이트', category: 'place', gradient: 'linear-gradient(135deg, #9333ea, #c084fc)', emoji: '' },
  ...
  { id: 't17', label: '#파인다이닝', description: '특별한 날의 코스 요리', category: 'food', gradient: 'linear-gradient(135deg, #4c1d95, #7c3aed)', emoji: '' },
  ...
  { id: 't27', label: '#낮산책', description: '햇살 아래 여유 산책', category: 'time', gradient: 'linear-gradient(135deg, #0d9488, #5eead4)', emoji: '' },
...
export const balanceQuestions: BalanceQuestion[] = [
  ...
  {
    id: 'bq3',
    optionA: { id: 'bq3a', label: '분위기 있는 파인다이닝', emoji: '', gradient: 'linear-gradient(135deg, #4c1d95, #7c3aed)' },
...
export const vibeOptions: VibeOption[] = [
  ...
  { id: 'adventure', label: '모험적인', emoji: '', gradient: 'linear-gradient(135deg, #fbbf24, #fb923c)', description: '새로운 발견의 연속' },
  { id: 'emotional', label: '감성적인', emoji: '', gradient: 'linear-gradient(135deg, #f472b6, #fda4af)', description: '감성 충전 코스' },
  { id: 'foodie', label: '맛집 투어', emoji: '', gradient: 'linear-gradient(135deg, #f87171, #fdba74)', description: '미식가의 하루' },
]
